...
<body>
	...
	<div class="container">
		...
		<!-- Add a search form -->
			...
			<form action="/College/students/search" class="form-inline">

				<!-- Add a button -->
				<a href="/College/students/showFormForAdd"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/College/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/College/students/delete?studentId=${tempStudent.id}"
